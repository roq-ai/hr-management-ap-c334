...
import { useRoqClient, useBenefitFindManyWithCount } from 'lib/roq';
...
export function BenefitListPage(props: BenefitListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useBenefitFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.benefit.delete({ where: { id } });
      await mutate();
    } catch (error) {
