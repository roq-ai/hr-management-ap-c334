...
import { useRoqClient, useDepartmentFindManyWithCount } from 'lib/roq';
...
export function DepartmentListPage(props: DepartmentListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useDepartmentFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.department.delete({ where: { id } });
      await mutate();
    } catch (error) {
